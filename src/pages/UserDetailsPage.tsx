        ...
        <main style={{ flex: 1, padding: '2px 20px 40px 20px', display: 'flex', justifyContent: 'center' }}>
          <div style={{ width: '100%', margin: '0 auto', display: 'flex', flexDirection: 'column' }}>
            <div style={{
              ...
              <div style={{ padding: '32px 40px 40px 40px', width: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{
                  ...
                  {!editMode && (
                    <div style={{
                      ...
                      }} onMouseEnter={e => e.currentTarget.style.boxShadow = '0 2px 8px rgba(12, 129, 69, 0.2)'} onMouseLeave={e => e.currentTarget.style.boxShadow = '0 2px 8px rgba(12, 129, 69, 0.1)'}>
                        Edit
                      </button>
                      ...
                      <button style={{
                        ...
                        transition: 'transform 0.1s ease-in-out',
                      }} onMouseEnter={e => e.currentTarget.style.boxShadow = '0 2px 8px rgba(0, 123, 255, 0.2)'} onMouseLeave={e => e.currentTarget.style.boxShadow = '0 2px 8px rgba(0, 123, 255, 0.1)'}
                      onClick={() => {
                      ...
                      <button style={{
                        ...
                        transition: 'transform 0.1s ease-in-out',
                      }} onMouseEnter={e => e.currentTarget.style.boxShadow = '0 2px 8px rgba(220, 53, 69, 0.2)'} onMouseLeave={e => e.currentTarget.style.boxShadow = '0 2px 8px rgba(220, 53, 69, 0.1)'}>
                        Deactivate
                      </button>
                    </div>
                  )}
